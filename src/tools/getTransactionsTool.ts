// // src/tools/getTransactionsTool.ts
...
// //IDEA:  Tool input schema (strict validation for agent safety)
// export const getTransactionsToolSchema = z.object({
//     type: z.enum(["range", "category", "merchant","largest","all"]).default("all"),
...
// //INFO: Main tool function
// export async function getTransactionsTool(input: z.infer<typeof getTransactionsToolSchema>) {
...
//     //NOTE: Case 1: Date range query
//     if (type === "range") {
//         if (!startDate || !endDate) {
//             throw new Error("startDate and endDate are required for range query");
//         }

//         return await getTransactions(startDate, endDate);
//     }

//     //NOTE: Case 2: Category filter
//     if (type === "category") {
//         if (!category) {
//             throw new Error("category is required for category query");
//         }

//         return await getTransactionsByCategory(category);
//     }

//     //NOTE: Case 3: Merchant filter
//     if (type === "merchant") {
//         if (!merchant) {
//             throw new Error("merchant is required for merchant query");
//         }
