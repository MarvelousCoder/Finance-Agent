// INFO: Phase 5A — Spending Prediction Engine
...
//     static async predictNextMonthSpending(userId: string): Promise<SpendingForecast> {
...
//     /**
//      * SIMPLE LINEAR GROWTH RATE (v1 model)
//      */
...
//      */
//     private static predictByCategory(transactions: any[], growthRate: number) {
//         const categoryMap: Record<string, number> = {};

//         for (const tx of transactions) {
//             const category = tx.category || "uncategorized";
//             categoryMap[category] =
//                 (categoryMap[category] || 0) + Math.abs(tx.amount);
//         }
...
//     /**
//      * CONFIDENCE ENGINE (simple heuristic v1)
//      */
//     private static calculateConfidence(monthlyTotals: number[]): "low" | "medium" | "high" {
//         if (monthlyTotals.length < 3) return "low";

//         const variance =
//             monthlyTotals.reduce((acc, val, i, arr) => {
//                 if (i === 0) return acc;
//                 return acc + Math.abs(val - arr[i - 1]);
//             }, 0) / monthlyTotals.length;

//         if (variance < 5000) return "high";
//         if (variance < 20000) return "medium";
//         return "low";
//     }
// }
